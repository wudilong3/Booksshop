...
<div class="w_100_l top_title">
	<div class="main">
    	<p><a href="#">Buy more than one book and save big! </a><a href="indeexx.html">Read more</a></p>
    </div>
</div>
...
<div class="w_100_l">
	<div class="main">
      ...
      <div class="content">
            ...
            <form action="findAbook.do" method="post">
            	搜索：<input type="text" name="bookname" value="输入书名"/>
            	<input type="submit" value="搜索"/>
            </form><br/><br/>
                      所有商品：<a href="booklistt.do">亲，请点击这里</a><br/><br/><br/>
        	最新商品：<a href="newbookk.do">亲，请点击这里</a><br/><br/><br/>
        	最热商品：<a href="hotbookk.do">亲，请点击这里</a><br/><br/><br/>
        	商品分类：<a href="bookkindd.do">亲，请点击这里</a><br/><br/><br/>
      </div>
        <p class="index_hr"></p>
