...
<div class="w_100_l">
	<div class="main">
      ...
      <div class="content">
            ...
            <%
            	int i=0;
            	List<Newbook> asd=(List<Newbook>)request.getAttribute("newbooklist");
            %>
                      <table border="1">
                <tr><th>图书ID&nbsp;&nbsp;</th>
				<th>图书名&nbsp;&nbsp;单价</th>
				<th>&nbsp;&nbsp;BUY</th></tr>
				<c:forEach items="${newbooklist}" var="nea">
				<tr>
				<td>${nea.bookId}&nbsp;&nbsp;</td>
				<td>
					<%
				...
				<td>
					&nbsp;&nbsp;<a href="Bookbuy.do?id=${nea.bookId}">BUY</a>
				</td>
				</tr>
				</c:forEach>
				</table>
