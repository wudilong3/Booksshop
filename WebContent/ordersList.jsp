...
<div class="w_100_l">
	<div class="main">
      ...
      <div class="content">
            ...
            <%
            	List<User> u=(List<User>)request.getAttribute("Orderslist");
            %>
             <table border="1">
				<tr><th>订单号</th>
				<th>&nbsp;&nbsp;图书号</th>
				...
				<td>
					<%
					Iterator<Orders> it=u.get(0).getOrdersSet().iterator();
    				while(it.hasNext()) {
    						Orders o=it.next();
    						%>
    							&nbsp;&nbsp;<%=o.getOrderId() %>&nbsp;&nbsp;&nbsp;&nbsp;
    							<a href="deleteAorders.do?id=<%=o.getOrderId() %>">取消订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
    							<a href="showAorders.do?userId=<%=u.get(0).getUserId() %>&bookId=<%=o.getBookId() %>">详情</a>
    							<br/>
    						<% 
    					}
					%>
				...
				<td>
					<%
					Iterator<Orders> it1=u.get(0).getOrdersSet().iterator();
    				while(it1.hasNext()) {
    						Orders o=it1.next();
    						%>
    							&nbsp;&nbsp;<%=o.getBookId() %>&nbsp;&nbsp;&nbsp;&nbsp;<br/>
				...
				<td>国家：${ord.address.state}<br/>城市：${ord.address.city}<br/>街道：${ord.address.street}</td>
				<td></td>
				</tr>
				</c:forEach>
                </table>        
