        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <section class="sidebar">
                            ...
                            <ul class="sidebar-menu">
                                <li class="active">
                            <a href="general.jsp">
                                <i class="fa fa-gavel"></i> <span>Book管理系统</span>
                            </a>
                        </li>
                               <li class="active">
                            <a href="basic_form.jsp">
                                <i class="fa fa-globe"></i> <span>用户</span>
                            </a>
                        </li>

                                <li>
                                    <a href="simple.jsp">
                                        <i class="fa fa-glass"></i> <span>后台管理员</span>
                                    </a>
                                </li>
                ...
                <section class="content">
               	<form modelAttribute="book" action="updateBooksubmit.do" method="post" enctype="multipart/form-data">
               		书号：<input type="text" name="bookId" value="${book.bookId}"/><br/>
					书名：<input type="text" name="name" value="${book.name}"/><br/>
					价格：<input type="text" name="price" value="${book.price}"/><br/>
					简介：<input type="text" name="introduce" value="${book.introduce}"/><br/>
					封面：<input type="file" name="files"/><br/>
