...
<div class="w_100_l">
	<div class="main">
      ...
      <div class="content">
            ...
            <%
            	List<kind> ki=(List<kind>)request.getAttribute("akindbook");
            %>
            <table border="1">
            	<tr>
            		<td>书名</td>
            		<td>
            			<%
            			Iterator<Book> it3=ki.get(0).getBookSet().iterator();		
            	        while(it3.hasNext()) {
            				Book a=it3.next();
            				%>
            					<%=a.getName() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	...
            	<tr>
            		...
            		<td>
            			<%
            			Iterator<Book> it1=ki.get(0).getBookSet().iterator();		
            	        while(it1.hasNext()) {
            				Book a=it1.next();
            				%>
            					<%=a.getPrice() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	...
            	<tr>
            		...
            		<td>
            			<%
            			Iterator<Book> it2=ki.get(0).getBookSet().iterator();		
            	        while(it2.hasNext()) {
            				Book a=it2.next();
            				%>
            					<%=a.getIntroduce() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	...
            	<tr>
            		...
            		<td>
            			<%
            			Iterator<Book> it4=ki.get(0).getBookSet().iterator();		
            	        while(it4.hasNext()) {
            				Book a=it4.next();
            				%>
            					<img alt="图片" src="<%=a.getImgUrl()%>">
            				<%
            	        }
            			%>
            		</td>
            	...
            	<tr>
            		...
            		<td>
            			<%
            			Iterator<Book> it5=ki.get(0).getBookSet().iterator();		
            	        while(it5.hasNext()) {
            				Book a=it5.next();
            				%>
            					<a href="Bookbuy.do?id=<%=a.getBookId()%>">BUY</a>&nbsp;&nbsp;&nbsp;&nbsp;
            				<%
            	        }
            			%>
            		</td>
