        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <section class="content">
               	<form modelAttribute="book" action="insertbook.do" method="post" enctype="multipart/form-data">
                    		图书名：<input type="text" name="name"/><br/>
                    		图书价格：<input type="text" name="price"/></br>
                    		图书简介：<input type="text" name="introduce"/></br>
                    		图书封面：<input type="file" name="files"/><br/>
