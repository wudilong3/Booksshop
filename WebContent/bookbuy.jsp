 <a href="">亲，请点击这里</a><br/><%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
	...
	<div class="main">
      ...
      <div class="content">
			...
			<table border="1">
				...
				<th>&nbsp;&nbsp;简介</th>
				<th>&nbsp;&nbsp;封面</th></tr>
				<c:forEach items="${abook}" var="ab">
				<tr>
				<td>${ab.bookId}</td>
				<td>&nbsp;&nbsp;${ab.name}</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${ab.price}</td>
				<td>&nbsp;${ab.introduce}</td>
				<td>&nbsp;&nbsp;<img alt="图片" src="${ab.imgUrl}"></td>
				</tr>
				</c:forEach>
                </table><br/>
                添加购物车：<br/>
                <form action="jiaShopcur.do" method="post">
                	<c:forEach items="${abook}" var="ab">
                	图书号：<input type="text" name="bookId" value="${ab.bookId}"/><br/>
                	</c:forEach>
