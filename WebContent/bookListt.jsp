...
<div class="w_100_l">
	<div class="main">
      ...
      <div class="content">
            ...
            <ul>
        	<c:forEach items="${booklist}" var="atext">
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${atext.imgUrl}" alt="book" /></a></dd>
                        <dt>
                        	<p class="book_title"><a href="#" target="_blank">${atext.name}</a></p>
                            <p class="book_inline">${atext.price}</p>
                            <a class="book_buy" href="Bookbuy.do?id=${atext.bookId}" target="_blank">BUY</a>
                        </dt>
                    </dl>
                </li>
            </c:forEach>	
